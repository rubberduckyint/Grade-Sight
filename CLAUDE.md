...
**Current phase:** Phase 1 MVP — Specs 1 (scaffolding), 2 (DB schema + migrations), and 3 (Clerk auth integration) complete. Next: Spec 4 (external service abstraction layer).
